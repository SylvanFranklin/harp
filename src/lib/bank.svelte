...
<div class="flex items-center justify-center flex-row">
    ...
    <svg
        xmlns="http://www.w3.org/2000/svg"
        class={`w-32 h-32 ${active() ? "text-blue-500" : ""}}`}
        viewBox="0 0 24 24"
        ><path
            fill="currentColor"
    ...
    >
    <div>
        <h3 class={`text-center text-lg text-white font-bold ${active() && "text-5xl"}`}>
            {player.energy}
        </h3>

        <svg
            xmlns="http://www.w3.org/2000/svg"
            class="text-yellow-400 w-14 h-14"
            viewBox="0 0 24 24"
            ><path
                fill="currentColor"
